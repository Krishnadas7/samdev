                    ...
                    <div className="d-flex align-items-center order-lg-1 order-0 mb-lg-0 mb-4">
                        ...
                        <a href="https://www.facebook.com/HelloSandwYch/" className="social-links">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                ...
                                <path
                                    d="M19.5007 2.16699H16.2507C14.8141 2.16699 13.4363 2.73768 12.4205 3.7535C11.4047 4.76932 10.834 6.14707 10.834 7.58366V10.8337H7.58398V15.167H10.834V23.8337H15.1673V15.167H18.4173L19.5007 10.8337H15.1673V7.58366C15.1673 7.29634 15.2815 7.02079 15.4846 6.81763C15.6878 6.61446 15.9633 6.50033 16.2507 6.50033H19.5007V2.16699Z"
                                    fill="#B3B3B3" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/hellosandwych/" className="social-links">
                            <svg width="24" height="23" viewBox="0 0 24 23" fill="none"
                                ...
                                <g clip-path="url(#clip0_2349_7409)">
                                    <path
                                        d="M17.5 6.22949H17.51M7 1.91699H17C19.7614 1.91699 22 4.06229 22 6.70866V16.292C22 18.9384 19.7614 21.0837 17 21.0837H7C4.23858 21.0837 2 18.9384 2 16.292V6.70866C2 4.06229 4.23858 1.91699 7 1.91699ZM16 10.8966C16.1234 11.6941 15.9813 12.5087 15.5938 13.2244C15.2063 13.9401 14.5931 14.5204 13.8416 14.8829C13.0901 15.2454 12.2384 15.3716 11.4078 15.2435C10.5771 15.1154 9.80976 14.7396 9.21484 14.1694C8.61992 13.5993 8.22773 12.8639 8.09407 12.0679C7.9604 11.2718 8.09206 10.4556 8.47033 9.73543C8.84859 9.01523 9.45419 8.42766 10.201 8.05631C10.9478 7.68495 11.7978 7.54872 12.63 7.66699C13.4789 7.78763 14.2648 8.16673 14.8717 8.74829C15.4785 9.32984 15.8741 10.083 16 10.8966Z"
                                        stroke="#B3B3B3" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </g>
                                <defs>
                                    <clipPath id="clip0_2349_7409">
                        ...
                        <a href="https://www.linkedin.com/company/sandwych/" className="social-links">
                            <svg width="34" height="34" viewBox="0 0 34 34" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M22.6654 11.3335C24.9197 11.3335 27.0817 12.229 28.6758 13.8231C30.2698 15.4171 31.1654 17.5792 31.1654 19.8335V29.7502H25.4987V19.8335C25.4987 19.082 25.2002 18.3614 24.6688 17.83C24.1375 17.2987 23.4168 17.0002 22.6654 17.0002C21.9139 17.0002 21.1932 17.2987 20.6619 17.83C20.1305 18.3614 19.832 19.082 19.832 19.8335V29.7502H14.1654V19.8335C14.1654 17.5792 15.0609 15.4171 16.655 13.8231C18.249 12.229 20.411 11.3335 22.6654 11.3335Z"
                                    fill="#B3B3B3" />
                                <path d="M8.4987 12.7502H2.83203V29.7502H8.4987V12.7502Z" fill="#B3B3B3" />
                                <path
                                    d="M5.66536 8.50016C7.23017 8.50016 8.4987 7.23164 8.4987 5.66683C8.4987 4.10202 7.23017 2.8335 5.66536 2.8335C4.10056 2.8335 2.83203 4.10202 2.83203 5.66683C2.83203 7.23164 4.10056 8.50016 5.66536 8.50016Z"
                                    fill="#B3B3B3" />
                            </svg>
                        </a>
                    </div>
